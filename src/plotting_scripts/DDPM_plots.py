"""!@file DDPM_plots.py
@brief Plotting script for the DDPM model.

@details This file contains the code to generate plots for the DDPM
...
Specifically, this script generate figures 4, 5, 7, 8, 9 in the report.
